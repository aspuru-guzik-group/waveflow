...
def train_model(target, num_epochs, n_model_sample, model_type='IFlow', 
    ...
    if model_type == "Flow":
        data_save_dir =  f"{save_dir}/{dataset_name}/{model_type}_{num_flow_layer}"
    else:
        data_save_dir = f"{save_dir}/{dataset_name}/{model_type}_{spline_reg}_{num_flow_layer}_{spline_degree}_{num_knots}/"
