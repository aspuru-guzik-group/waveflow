...
#    return all_x
#
# # sample_fun_vec = jit(partial(vmap(sample_fun, in_axes=(0, 0, None, None)), static_argnums=(3,)))
...
#    s = sample_fun_vec(rng_array, params, 1, 2).T
#
# fig, ax = plt.subplots()
# ax.plot(xx, apply_fun_vec(params, xx), label='fun')
# ax.hist(np.array(s), density=True, bins=100, label='hist')
# ax.grid(True)
# ax.legend(loc='best')
# plt.show()
